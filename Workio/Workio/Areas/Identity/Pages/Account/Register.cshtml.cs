        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var statusCode = _emailService.ConfirmEmail(Input.Email, callbackUrl);
                    ...
                    {
                        ModelState.AddModelError(string.Empty, _stringLocalizer.Get("Error sending email confirmation. Please try again later."));
                    }

...
namespace Workio.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<User> signInManager, ILogger<LoginModel> logger, IToastNotification toastNotification, IUserService userService)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    _toastNotification.AddErrorToastMessage("Invalid login");
                    return Page();
                }
            }

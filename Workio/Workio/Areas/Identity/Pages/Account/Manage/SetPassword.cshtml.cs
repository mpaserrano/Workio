...
namespace Workio.Areas.Identity.Pages.Account.Manage
{
    public class SetPasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [RegularExpression(@"^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!#%*?&]{8,}$", ErrorMessage = "Your password must have at least one non-alphanumeric character, one uppercase letter, one lowercase letter, and be at least 8 characters long.")]

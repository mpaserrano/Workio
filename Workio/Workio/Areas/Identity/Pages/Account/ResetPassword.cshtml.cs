...
namespace Workio.Areas.Identity.Pages.Account
{
    public class ResetPasswordModel : PageModel
    {
        ...
        public IActionResult OnGet(string code = null, string email_encoded = null)
        {
            if (code == null || email_encoded == null)
            {
            ...
            else
            {
                Input = new InputModel
                {
                    ...
                    Email = Encoding.UTF8.GetString(WebEncoders.Base64UrlDecode(email_encoded))
                };
                return Page();
            }
        }

...
namespace SeleniumTests
{
    ...
    public class BEditTeam
    {
        ...
        public void TheEditTeamTest()
        {
            ...
            driver.FindElement(By.Id("team-input-search")).SendKeys("Create Team Katalon Test");
            ...
            driver.FindElement(By.Id("TeamName")).SendKeys("Edited Team Katalon Test");
            driver.FindElement(By.Id("LanguageLocalizationId")).Click();
            new SelectElement(driver.FindElement(By.Id("LanguageLocalizationId"))).SelectByText("Português");
            driver.FindElement(By.Id("Description")).Click();
            driver.FindElement(By.Id("Description")).Clear();
            driver.FindElement(By.Id("Description")).SendKeys("Teste automaçao 2.0");

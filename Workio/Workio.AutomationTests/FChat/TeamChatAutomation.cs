...
{
    [TestClass]
    public class TeamChatAutomation
    {
        ...
        [TestMethod]
        public void TheTeamChatAutomationTest()
        {
            ...
            driver.FindElement(By.Id("TeamName")).SendKeys("Chat Automation Team Katalon 15");
            driver.FindElement(By.Id("Description")).Click();
            driver.FindElement(By.Id("Description")).Clear();
            driver.FindElement(By.Id("Description")).SendKeys("Using Katalon");
            driver.FindElement(By.Id("submit-team")).Click();
            ...
            driver.FindElement(By.Id("account")).Submit();
            driver.FindElement(By.LinkText("Teams")).Click();
            driver.FindElement(By.Id("team-input-search")).Click();
            driver.FindElement(By.Id("team-input-search")).Clear();
            driver.FindElement(By.Id("team-input-search")).SendKeys("Chat Automation Team Katalon 15");
            ...
            var toastTitleElement2 = By.ClassName("toast-title");
            wait.Until(ExpectedConditions.InvisibilityOfElementLocated(toastTitleElement));
            var profilePictureElement2 = By.XPath("//img[@alt='Profile Picture']");
            wait2.Until(ExpectedConditions.ElementToBeClickable(profilePictureElement)).Click();
            driver.FindElement(By.Id("user-logout-option")).Click();
            driver.FindElement(By.LinkText("Login")).Click();
            driver.FindElement(By.Id("Input_Email")).Clear();
            driver.FindElement(By.Id("Input_Email")).SendKeys("testeautomacao1@mail.com");
            ...
            driver.FindElement(By.LinkText("Open Chat")).Click();
            ...
            driver.FindElement(By.Id("message_to_send")).SendKeys("We're all here gathered to see if everyone receives my message!");
            ...
            driver.FindElement(By.Id("message_to_send")).Click();
            driver.FindElement(By.Id("message_to_send")).Clear();
            driver.FindElement(By.Id("message_to_send")).SendKeys("I did receive your message!");
            driver.FindElement(By.Id("message_to_send")).SendKeys(Keys.Enter);

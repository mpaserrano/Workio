...
namespace SeleniumTests
{
    ...
    public class CAddSkill
    {
        ...
        public void TheCAddSkillTest()
        {
            ...
            driver.FindElement(By.CssSelector("svg.svg-inline--fa.fa-plus.fa-xl > path")).Click();

            var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(10));
            var modalElement = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("skillForm")));

            driver.FindElement(By.Id("Name")).Click();
            driver.FindElement(By.Id("Name")).Clear();
            driver.FindElement(By.Id("Name")).SendKeys("Katalon");
            driver.FindElement(By.Id("submit-skill")).Click();
        }
